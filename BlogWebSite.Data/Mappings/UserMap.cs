...
namespace BlogWebSite.Data.Mappings
{
    public class UserMap : IEntityTypeConfiguration<AppUser>
    {
        public void Configure(EntityTypeBuilder<AppUser> builder)
        {
            ...
            {
                Id = Guid.Parse("20461BA2-1457-4303-AEF9-15173DDBB9B5"),
                ...
                ImageId = Guid.Parse("242a5458-7d57-4dd6-abea-c5e99e626e87"),
                IsDeleted = false
            };
            ...
            {
                Id = Guid.Parse("84461BA2-1457-4303-AEF9-15173DDBB9B5"),
            ...
            admin1.PasswordHash = CreatePasswordHash(admin1, "123456");

            var admin2 = new AppUser
            {
                Id = Guid.Parse("99461BA2-1457-4303-AEF9-15173DDBB9B5"),
            ...
            admin2.PasswordHash = CreatePasswordHash(admin2, "123456");
